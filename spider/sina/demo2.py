...
# http://www.oschina.net/code/snippet_1781236_36190
...
def login_weibo(nick, pwd):
    ...
    s = post_data('http://login.sina.com.cn/sso/login.php?client=ssologin.js(v1.4.15)', param)
    ...
    text = get_data('http://weibo.com/527891819/home?wvr=5&lf=reg')
    fp = open('yeah.txt', 'w', encoding='utf-8')
    fp.write(text)
    fp.close()

login_weibo('return_zero0@163.com', '******')
